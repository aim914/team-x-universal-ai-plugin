# team-x-Inspired Claude Code Guidelines
...
```
/plugin marketplace add aim914/team-x-universal-ai-plugin
```

Then install the plugin:
```
/plugin install team-x-universal-ai-plugin@team-x-universal-ai-plugin
```
...
New project:
```bash
curl -o CLAUDE.md https://raw.githubusercontent.com/aim914/team-x-universal-ai-plugin/main/CLAUDE.md
```
